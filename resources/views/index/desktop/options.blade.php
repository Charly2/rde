                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="app-btns v4">
                            <a href="{{url('desktop/'.$sucursal.'/encuesta/'.$nombre.'/'.$telefono)}}" class="app-btn align-self-center">
                            ...
                            <a href="{{url('desktop/'.$sucursal.'/comentario/'.$nombre.'/'.$telefono)}}" class="app-btn active align-self-center">
                                <span class="app-btn-icon">
