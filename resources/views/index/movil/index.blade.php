...
@section("content")
    <style>
        body{
            background-image: url("/assets/img/v2/DRD3D_App_Layout9.jpg")!important;
        }
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input autocomplete="off"  type="text" class="form-control input_mobil" id="nombre" aria-describedby="emailHelp"  placeholder="Ingrese su nombre completo">
        ...
        $(document).ready(function () {
            ...
            $(".input_mobil_finish").on("keypress", function(event){
                if (event.keyCode == 13) {
                    event.preventDefault();
                    event.target.blur();
                    window.location.href = "{{url('movil/'.$sucursal.'/options/')}}/"+$('#nombre').val()+'/'+$('#telefono').val()
                }
            });
            ...
            $('.next_to_options').click(function (e) {
                ...
                window.location.href = "{{url('movil/'.$sucursal.'/options/')}}/"+nombre+'/'+telefono
            });
